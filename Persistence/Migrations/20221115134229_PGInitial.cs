        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopScorerId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BestResult = table.Column<string>(type: "text", nullable: true),
                    BestResultDates = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BetDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Points = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChampionBets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChampionBets_Teams_ChampionId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TopScorerId = table.Column<Guid>(type: "uuid", nullable: false),
                    BetDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Points = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TopScorerBets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TopScorerBets_Players_TopScorerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChampionBetId = table.Column<Guid>(type: "uuid", nullable: true),
                    TopScorerBetId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChampionBets_ChampionId",
                table: "ChampionBets",
                column: "ChampionId");
